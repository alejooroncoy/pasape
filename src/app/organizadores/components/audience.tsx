...
export function Audience() {
  return (
    <section id="para-quien" className="py-24 md:py-30">
      <div className="mx-auto w-full max-w-[1160px] px-[22px] md:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-3.5 lg:grid-cols-3">
          {AUDIENCE.map((a, i) => (
            <div
              key={a}
              className="reveal group relative grid grid-cols-[40px_1fr_auto] items-center gap-4 overflow-hidden rounded-2xl border border-line bg-[linear-gradient(180deg,rgba(255,255,255,0.025),rgba(255,255,255,0)),var(--color-bg-elev)] px-5 py-5 transition-[transform,border-color] duration-200 hover:-translate-y-0.5 hover:border-accent/40 before:pointer-events-none before:absolute before:inset-0 before:bg-[linear-gradient(135deg,rgba(184,124,255,0.06),transparent_60%)] before:opacity-0 before:transition-opacity hover:before:opacity-100"
            >
              ...
              <span className="relative z-10 text-ink-4 opacity-0 transition-[opacity,transform,color] duration-200 group-hover:translate-x-0.5 group-hover:text-accent group-hover:opacity-100">
