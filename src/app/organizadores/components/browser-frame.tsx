  ...
  if (device === "phone") {
    return (
      <div className="phone-frame mx-auto w-full max-w-[min(280px,80vw)]">
        <div className="phone-frame-shell overflow-hidden rounded-[26px] border border-line-strong bg-bg-elev-2 shadow-[0_32px_64px_-28px_rgba(0,0,0,0.85),0_0_0_1px_rgba(184,124,255,0.12)]">
          <div className="browser-frame-grain" aria-hidden="true" />
          <div className="relative flex items-center justify-between border-b border-line bg-bg-elev/80 px-4 pb-1.5 pt-2">
            <span className="font-mono text-[10px] font-medium tabular-nums text-ink-3">9:41</span>
            <div className="absolute left-1/2 top-1.5 h-[16px] w-[64px] -translate-x-1/2 rounded-full bg-bg" aria-hidden="true" />
          ...
          <div className="relative flex items-center gap-1.5 border-b border-line bg-bg-elev/50 px-3 py-1.5">
            <svg width="9" height="9" viewBox="0 0 10 10" fill="none" className="shrink-0 text-ink-4">
              <rect x="2" y="4.5" width="6" height="4" rx="1" stroke="currentColor" />
              <path d="M3.2 4.5V3a1.8 1.8 0 0 1 3.6 0v1.5" stroke="currentColor" />
            </svg>
            <span className="min-w-0 flex-1 truncate text-center font-mono text-[10px] text-ink-3">{url}</span>
          </div>
          <div className="relative bg-bg p-2.5">
            {children}
          </div>
          <div className="flex justify-center border-t border-line bg-bg-elev/40 py-1.5" aria-hidden="true">
