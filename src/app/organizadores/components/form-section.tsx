...
export function FormSection({ waHref }: { waHref: string }) {
  return (
    <section
      id="form"
      className="relative overflow-hidden border-t border-line bg-[radial-gradient(ellipse_at_50%_0%,rgba(184,124,255,0.18),transparent_60%),linear-gradient(180deg,var(--color-bg-purple-deeper)_0%,var(--color-bg)_100%)] py-24 pb-28 md:py-30 before:pointer-events-none before:absolute before:bottom-[-200px] before:left-1/2 before:h-[400px] before:w-[800px] before:-translate-x-1/2 before:bg-[radial-gradient(ellipse,rgba(184,124,255,0.25),transparent_70%)] before:blur-[80px] before:content-['']"
    >
