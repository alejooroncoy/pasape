...
export function WaFloat({ waHref }: { waHref: string }) {
  return (
    <a
      ...
      className="fixed right-[18px] bottom-[18px] z-[60] grid size-14 place-items-center rounded-full bg-cart-accent text-white shadow-[0_0_0_1px_rgba(255,255,255,0.14)_inset,0_14px_30px_-8px_var(--color-cart-accent-glow-strong)] transition-[transform,box-shadow,filter] duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.04] hover:brightness-110 md:right-6 md:bottom-6"
    >
