...
// Desbloqueo post-pago: "ya pagaste, entra para guardar tus entradas". Un tap con
// Google → claimOrder engancha la compra a tu cuenta → a tu billetera. Paso
// pensado para ser rápido y que cualquiera lo entienda.
