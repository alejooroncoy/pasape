...
function Feature({ title, text }: { title: string; text: string }) { return <div><div className="grid size-10 place-items-center rounded-xl bg-cart-accent/10 text-lg text-cart-accent">✦</div><h2 className="mt-5 text-xl font-semibold tracking-[-.025em] text-cart-ink">{title}</h2><p className="mt-2 leading-7 text-cart-ink-2">{text}</p></div>; }
