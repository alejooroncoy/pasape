...
export function FeaturedBanner() {
  ...
  return (
    ...
    >
      {/* En vez de repetir el título gigante (que se cortaba y competía con
          la ficha), dejamos una firma editorial discreta: identifica el
          bloque sin tapar la información que realmente importa. */}
      <div aria-hidden className="pointer-events-none absolute bottom-6 right-7 hidden items-center gap-3 sm:flex">
        <span className="h-px w-12 bg-cart-accent/45" />
        <span className="font-mono text-[10px] font-semibold uppercase tracking-[.18em] text-cart-accent/70">Evento destacado · Pasape</span>
      </div>
