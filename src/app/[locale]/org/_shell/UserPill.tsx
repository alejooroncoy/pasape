    ...
    <div ref={ref} className="relative">
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          <span className="block truncate text-[13px] font-semibold text-cart-ink">{displayName}</span>
          {user.email && (
        ...
        {open && (
          ...
          >
            <div className="border-b border-cart-line px-3.5 py-3">
              ...
              <div className="mt-1 truncate text-[13px] font-semibold text-cart-ink">{displayName}</div>
              {user.email && (
