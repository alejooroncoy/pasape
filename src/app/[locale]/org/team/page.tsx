...
function CoorgTab() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <AnimatePresence>
        {open && (
          <Sheet onClose={() => setOpen(false)} title="Invitar co-organizador" shortcutHint>
            <CoorgInviteForm
...
function PromotersTab() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <AnimatePresence>
        {adding && (
          <Sheet onClose={() => setAdding(false)} title="Nuevo promotor" shortcutHint>
            <PromoterForm
        ...
        {editing && (
          <Sheet onClose={() => setEditing(null)} title={`Editar ${editing.name}`} shortcutHint>
            <PromoterForm
              initial={editing}
