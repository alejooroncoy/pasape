  ...
  return (
    <PublicAppShell user={user}>
      ...
      <section aria-labelledby="faq-heading" className="mt-10">
        <h2 id="faq-heading" className="text-[20px] font-semibold text-cart-ink">
          Preguntas frecuentes
        </h2>
        <dl className="mt-5 space-y-4">
          {faqs.map(({ q, a }) => (
            <div key={q} className="rounded-2xl border border-cart-line bg-cart-bg-elev/40 p-5">
              <dt className="text-[15px] font-medium text-cart-ink">{q}</dt>
      ...
      <section aria-labelledby="links-heading" className="mt-10">
        <h2 id="links-heading" className="text-[20px] font-semibold text-cart-ink">
          Más recursos
        </h2>
        <ul className="mt-4 flex list-none flex-col gap-2 p-0 text-[14px] text-cart-ink-2">
          <li>
            <Link href="/" className="hover:text-cart-ink">
              Ver eventos
            </Link>
          </li>
          <li>
            <Link href="/organizadores" className="hover:text-cart-ink">
              Soy organizador
            </Link>
          </li>
          <li>
            <Link href="/reclamos" className="hover:text-cart-ink">
