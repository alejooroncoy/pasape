          ...
          >
            ...
            <div className="p-1">
              <MenuItem
                ...
                onClick={() => {
                  setOpen(false);
                  router.push("/promo/profile" as never);
                }}
              />
              <MenuItem
                icon={
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M3 17V8m4 9V5m4 12v-7m4 7v-4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                  </svg>
                }
                label="Ganancias"
                onClick={() => {
                  setOpen(false);
                  router.push("/promo/earnings" as never);
                }}
              />
              <MenuItem
                icon={
